...
async function downloadAddTemplate(targetPath, taroPageTemplate) {
    const { npmName, version } = taroPageTemplate
...
export default async function downloadTaroPage(taroPageTemplate) {
